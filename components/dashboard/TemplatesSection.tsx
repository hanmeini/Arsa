      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {templates.map((template) => (
          <Link
            ...
            key={template.id}
            className="group bg-white p-4 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl hover:translate-y-[-4px] transition-all duration-300 flex flex-col"
          >
            {/* Image Area */}
            <div
              className={`aspect-square rounded-2xl mb-4 relative overflow-hidden ${template.bgColor} flex items-center justify-center group-hover:scale-[1.02] transition-transform duration-500`}
            >
            ...
            <div className="space-y-2 flex-1 flex flex-col justify-between">
              <div>
                ...
                <h4 className="font-bold text-gray-900 text-lg mb-1 group-hover:text-[#0F4C75] transition-colors">
                  {template.title}
                </h4>
              </div>
              ...
              <div className="flex justify-between items-end gap-2">
                ...
                <div className="bg-[#0F4C75] text-white text-[10px] font-bold py-2 px-4 rounded-full flex items-center gap-1 group-hover:bg-[#0a3655] transition-colors shrink-0">
