  ...
  return (
    <div className="min-h-screen flex bg-white overflow-hidden">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center relative">
        ...
        {/* Curved Divider (SVG) - Visible only on Desktop */}
        ...
        {/* Mobile Top Curve (Optional) */}
        <div className="absolute top-[-1px] left-0 right-0 h-[10vh] lg:hidden w-full fill-white z-0 bg-white"></div>
